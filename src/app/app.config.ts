...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    importProvidersFrom(LucideAngularModule.pick({
      ...
      ArrowLeft, Pencil, X, AlertTriangle, Users, User, UserPlus, Mail, Lock, Check, CheckCircle, ArrowRight, LogOut, ShieldAlert, Loader2
    }))
  ]
};
